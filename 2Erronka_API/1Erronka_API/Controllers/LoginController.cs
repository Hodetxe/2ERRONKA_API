    ...
    public class LoginController : ControllerBase
    {
        ...
        public IActionResult Login([FromBody] LoginRequest request)
        {
            try 
            {
                ...
                var pasahitzaZuzena =
                    string.Equals(langilea.Pasahitza, pasahitzaHash, StringComparison.OrdinalIgnoreCase) ||
                    langilea.Pasahitza == request.Pasahitza;
                ...
                var gerentea = langilea.RolaId == 1;
                var tpvSarrera = !langilea.Ezabatua && (langilea.RolaId == 1 || langilea.RolaId == 2);
                ...
                return Ok(new LoginErantzuna
                {
                    ...
                    Data = new LangileaDto
                    {
                        ...
                        RolaId = langilea.RolaId,
                        Ezabatua = langilea.Ezabatua,
                        Chat = langilea.Chat,
                        Gerentea = gerentea,
                        TpvSarrera = tpvSarrera
                    }
                });
            }
            catch (Exception ex)
