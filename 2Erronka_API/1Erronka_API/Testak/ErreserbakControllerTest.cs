...
namespace _1Erronka_API.Testak
{
    public class ErreserbakControllerTests
    {
            ...
            Mock<_1Erronka_API.Repositorioak.OsagaiaRepository>? osaMock = null)
        {
            ...
            envMock.SetupGet(e => e.WebRootPath).Returns(Path.Combine(Directory.GetCurrentDirectory(), "wwwroot"));
            Directory.CreateDirectory(envMock.Object.WebRootPath);
            Directory.CreateDirectory(Path.Combine(envMock.Object.WebRootPath, "tiketak"));
            return new ErreserbakController(repoMock.Object, eskMock.Object, prodMock.Object, poMock.Object, osaMock.Object, envMock.Object);
        }
        ...
        public void Ordaindu_ErreserbaExistitzenDenenean_FakturaSortuEtaOkItzuli()
        {
            ...
            sessionMock.Setup(s => s.BeginTransaction(IsolationLevel.ReadCommitted)).Returns(new Mock<NHibernate.ITransaction>().Object);
            ...
            repoMock.SetupSequence(r => r.OpenSession()).Returns(sessionMock.Object).Returns(sessionMock.Object);
            repoMock.Setup(r => r.LortuProduktuakErreserbarako(10, sessionMock.Object)).Returns(new List<EskariaProduktuaDto>());
