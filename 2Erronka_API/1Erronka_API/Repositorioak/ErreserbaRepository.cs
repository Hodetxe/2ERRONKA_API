...
namespace _1Erronka_API.Repositorioak
{
    public class ErreserbaRepository
    {
        ...
        {
            return LortuProduktuakErreserbarako(erreserbaId, _session);
        }

        public virtual List<EskariaProduktuaDto> LortuProduktuakErreserbarako(int erreserbaId, ISession session)
        {
